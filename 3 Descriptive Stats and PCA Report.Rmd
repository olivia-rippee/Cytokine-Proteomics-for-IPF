...
cat_vars <- c("Diag_Short", "Sex", "Race", "Ethnicity", "Smoking History", "SecondHandSmoke")
...
```{r missingness fraction}

readRDS("Plots/missingness_fraction.jpg")
...
```{r PCA removed subjects}

readRDS("Plots/PCA_remove_subjects.jpg")
...
readRDS("Plots/PCA_remove_NAs.jpg")
...
```{r PCA IPF random sample}

include_graphics("Plots/PCA_IPF_random_sample.png")
